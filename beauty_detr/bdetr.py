...
from utils.bdetr_misc import (NestedTensor, nested_tensor_from_tensor_list,
...
def build_bdetr(args):
    ...
    transformer = build_beauty_detr_transformer(
        args, backbone.backbone.butd_class_embeddings if args.butd else None)  # encoder & decoder
