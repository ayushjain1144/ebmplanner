...
from utils.bdetr_misc import inverse_sigmoid
from beauty_detr.ops.modules import MSDeformAttn
import ipdb
st = ipdb.set_trace
...
def build_beauty_detr_transformer(args, butd_class_embeddings):
    return BeautyDetrTransformer(
        ...
        two_stage=args.two_stage,  # and not args.use_contrastive_postprocess,
