...
class RealRobotCamera():
    """Default configuration with 1 RealSense RGB-D cameras."""
    # Mimic RealSense D415 RGB-D camera parameters.
    image_size = (480, 640)
    intrinsics = (610.6864013671875, 0.0, 638.60693359375-290, 0.0, 610.6304931640625, 366.0154724121094-120, 0.0, 0.0, 1.0)
...
class RealSenseD415():
    ...
    front_position_vid = (1., 0, 0.75)
    front_rotation_vid = (np.pi / 4, np.pi, -np.pi / 2)
    front_rotation_vid = p.getQuaternionFromEuler(front_rotation_vid)
    ...
    CONFIG = [{
        ...
        'image_size': image_size,
        'intrinsics': intrinsics,
        'position': front_position_vid,
        'rotation': front_rotation_vid,
        'zrange': (0.01, 10.),
        'noise': False
    }]


class RealSenseD415_topdown():
    """Default configuration with 3 RealSense RGB-D cameras."""

    # Mimic RealSense D415 RGB-D camera parameters.
    image_size = (320,640)
    intrinsics = (450., 0, 320., 0, 450., 160., 0, 0, 1)
